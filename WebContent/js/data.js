...
const qnaList = [
	{
		q: '정확한 분석을 위해 당신의 성별을 선택해주세요!',
		a: [
			{ answer: 'a. 여성', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[1] },
			{ answer: 'b. 남성', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[2] }
		]
	},
	{
		q: '정확한 분석을 위해 당신의 나이를 선택해주세요!',
		a: [
			{ answer: 'a. 10대', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[1] },
			{ answer: 'B. 20대', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[2] },
			{ answer: 'c. 30대', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[3] },
			{ answer: 'd. 40대 이상', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[4] },
		]
	},
	{
		q: '1. 일정없는 주말에 당신은??',
		a: [
			{ answer: 'a. 친구들 만나야지 연락연락!!', type: [0], db:[0] },
			{ answer: 'b. 침대 개꿀? 내가 곧 침대', type: [1], db:[0] }
		]
	},
	{
		q: '2. 5년만에 우연히 동창을 만났다 당신은??',
		a: [
			{ answer: 'a. 먼저 말을 걸면서 인사하고 이야기를 한다!', type: [0], db:[0] },
			{ answer: 'b. 인사는 했지만 다음 말을 걸어올 때까지 기다린다.', type: [1], db:[0] }
		]
	},
	{
		q: '3. 배우고 싶은 취미를 들을 수 있는 기회가 생긴다면 당신은??',
		a: [
			{ answer: 'a. 퇴근 후에 배운다', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[1] },
			{ answer: 'b. 쉬는 날에 배운다.', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[2] }
		]
	},

	{
		q: '4. 미술을 배운다 어떤걸 그릴까?',
		a: [
			{ answer: 'a. 독특하고 창의력 돋는 추상화 같은 그림!!', type: [2], db:[0] },
			{ answer: 'b. 사실적 묘사나 풍경화 같이 사물의 특징!!', type: [3], db:[0] }
		]
	},
	{
		q: '5. 집에서 한달의 휴가을 받은 당신, 당신의 모습은??',
		a: [
			{ answer: 'a. 처음에는 좋지만, 곧 싫증이나 친구를 만나고싶다...', type: [0], db:[0] },
			{ answer: 'b. 개꿀 넷플릭스 한달내내 봐야지 홀라러 개꿀띠', type: [1], db:[0] }
		]
	},
	{
		q: '6. 수업도중 모르는 것이 있을때 당신은??',
		a: [
			{ answer: 'a. 바로바로 물어본다.', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[1] },
			{ answer: 'b. 끝나고 선생님께 따로 물어본다.', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[2] }
		]
	},
	{
		q: '7. 당신은 어떤 칭찬을 받고 싶다?',
		a: [
			{ answer: 'a. 너와 같은 팀이어서 너무 좋아!', type: [5], db:[0] },
			{ answer: 'b. 너의 정보처리 능력을 통해 이 일정을 줄인 것이 대단해!', type: [4], db:[0] }
		]
	},
	{
		q: '8. 친구가 취미를 추천해달라고 한다. 당신의 대답은??',
		a: [
			{ answer: 'a. 이것 저것 묻고 맞춤형으로 추천해준다.', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[1] },
			{ answer: 'b. 최근 내가 했던 취미 중 가장 재밌었던 취미를 추천해준다.', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[2] },
		]
	},
	{
		q: '9. 영화에서 쫓기는 장면을 봤을 때 당신은??',
		a: [
			{ answer: 'a. 무념무상', type: [3], db:[0] },
			{ answer: 'b. 집에 돌아와서 쫓기는 장면을 생각하며 아! 나였으면 이렇게 도망갔을텐데!', type: [2], db:[0] },
		]
	},
	{
		q: '10. 내일 좋아하는 이성을 만난다 당신은??',
		a: [
			{ answer: 'a. 음 대충 이거입어야겠다. 아 내일 생각하자.', type: [7], db:[0] },
			{ answer: 'b. 아 내일 뭐입지? 이거입을까? 하루전 머리부터 발끝까지 세팅!', type: [6], db:[0] }
		]
	},
	{
		q: '11. 친구가 정신적으로 힘들어 할 때 당신은??',
		a: [
			{ answer: 'a. 심리상담을 받아보라고 추천해준다.', type: [4], db:[0] },
			{ answer: 'b. 이야기를 들어주고 힘이 되어준다.', type: [5], db:[0] }
		]
	},
	{
		q: '12. 흥미가 생긴 분야가 있으면??',
		a: [
			{ answer: 'a. 금방 사라지는 편', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[1] },
			{ answer: 'b. 오래오래 간직하는편', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[2] }
		]
	},
	{
		q: '13. 금요일 저녁 운동을 하려고 한다. 어디서 운동을 할까??',
		a: [
			{ answer: 'a. 시끄럽고 화려한 헬스장에서 트레이너에게 배운다!', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[1] },
			{ answer: 'b. 트레이너를 편안한 집으로 초대해서 배운다!', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[2] },
			{ answer: 'c. 운동은 무슨 귀찮아! 그냥 집에서 잘래.', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[3] }
		]
	},
	{
		q: '14. 코로나 사태를 다루는 뉴스를 볼 때 당신은 어떤 뉴스를 선호하나요?',
		a: [
			{ answer: 'a. 의료진의 노고, 기부릴레이와 같은 뉴스를 선호한다.', type: [5], db:[0] },
			{ answer: 'b. 바이러스의 원인, 출처와 같은 심층 분석 뉴스를 선호 한다.', type: [4], db:[0] }
		]
	},
	{
		q: '15. 여행가기로 했다 당신은??',
		a: [
			{ answer: 'a. 음 일단 점심은 여기서 먹고 그다음 여기 들렸다가 저녁은 찰리레스토랑에서 먹어야지.', type: [6], db:[0] },
			{ answer: 'b. 방만 예약하고 몸뚱이만 있으면 끝 대충가자ㅋㅋ', type: [7], db:[0] }
		]
	},
	{
		q: '16. 취미를 만들려고 한다 어떤 것을 할까?',
		a: [
			{ answer: 'a. 역시 취미는 신나는 운동이지!', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[1] },
			{ answer: 'b.정적인 독서가 좋아~', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[2] },
			{ answer: 'c. 나는 음악을 배워볼래!', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[3] },
			{ answer: 'd. 난 뭔가 만드는 걸 배워볼래~', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[4] },
			{ answer: 'e. 쿠킹 클래스가 역시 최고지~~', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[5] }
		]
	},
	{
		q: '17. 여행 후 숙소에서 이불에 누웠을 때 당신??',
		a: [
			{ answer: 'a. 이불의 촉감이 좋네? 오 좋다~', type: [2], db:[0] },
			{ answer: 'b. 오늘 있었던 일이 뭐지?', type: [3], db:[0] }
		]
	},
	{
		q: '18. 맛집을 대하는 당신은??',
		a: [
			{ answer: 'a. 맛있겠다 근데 줄 기다리긴 싫어 수고', type: [7], db:[0] },
			{ answer: 'b. 대기 줄이 적은 날짜와 요일을 찾아서 그날 가야지!! 헤헤 맛집', type: [6], db:[0] }
		]
	},
	{
		q: '19. 집에서 이성인 과외 선생님께 배운다면??',
		a: [
			{ answer: 'a. 동성이 편해!', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[1] },
			{ answer: 'b. 별루 상관없어', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[2] }
		]
	},
	{
		q: '20. 교육을 대하는 당신은??',
		a: [
			{ answer: 'a. 나는 집으로 선생님 부를래!', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[1] },
			{ answer: 'b. 무슨소리야 가서 배워야지', type: [0, 1, 2, 3, 4, 5, 6, 7], db:[2] }
		]
	},
]
